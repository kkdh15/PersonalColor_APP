...
def main():
    ...
    model = timm.create_model('efficientnet_b0', pretrained=True, num_classes=9).to(device)
    ...
    def train_model(model, train_loader, valid_loader, epochs=100, early_stopping_rounds=15):
